...
/***/ function(module, exports, __webpack_require__) {
	...
	window.DatePicker = __webpack_require__(1);
	...
	/***/function (module, exports, __webpack_require__) {
		...
		module.exports = React.createClass({
			...
			render: function render() {
				...
				return createElement('div', { className: styles['date-picker'], ref: 'comp' }, createElement('div', { className: styles['input'], style: style, onClick: this.onFocus }, createElement('span', { style: { padding: '0 ' + fontSize + 'px' } }, this.getDateText())), focused && createElement('div', { className: styles['picker-wrapper'] }, createElement('div', { className: styles['picker'], style: style }, createElement(PickerPanel, { lang: this.props.lang,
					width: width,
					date: date,
		...
		module.exports = React.createClass({
			...
			render: function render() {
				...
				var getCellElement = function (year, month, day, classNames) {
					...
					return createElement('td', { key: keyIndex++,
				...
				for (var _i3 = 0; _i3 < 6; _i3++) {
					...
					tableRows.push(createElement('tr', { key: _i3 }, oneRow));
				}

				return createElement('tbody', null, tableRows);
			}
		});
		...
		module.exports = React.createClass({
			...
			render: function render() {
				...
				var getCellElement = function (year, month, classNames) {
					...
					return createElement('div', { key: keyIndex++,
						className: classArray.map(function (className) {
							return styles[className];
						}).join(' '),
						onClick: this.onCellClick.bind(this, month)
					}, createElement('span', null, lang.month[month - 1]));
				}.bind(this);
				...
				for (var _i = 0; _i < 3; _i++) {
					...
					tableRows.push(createElement('tr', { key: _i }, createElement('td', { colSpan: '7' }, oneRow)));
				}
	...
	/***/function (module, exports, __webpack_require__) {
		...
		module.exports = React.createClass({
			...
			renderTitle: function renderTitle() {
				...
				return createElement('span', null, lang.panelTitle[funcType](panelYear, panelMonth));
			},
			...
			renderWeekTitle: function renderWeekTitle() {
				...
				if (this.state.panel == 1) {
					var _ret = function () {
						...
						return {
							v: createElement('tr', null, lang.weekTitle.map(function (title, index) {
								return createElement('th', { style: { width: width }, key: index }, title);
							}))
						};
					}();
			...
			render: function render() {
				return createElement('table', { ref: 'table' }, createElement('thead', null, createElement('tr', null, createElement('th', { onClick: this.switchStep.bind(this, -1) }, createElement('span', null, '<\xA0')), createElement('th', { colSpan: '5', onClick: this.switchTitle }, createElement('div', { key: 'title' }, this.renderTitle())), createElement('th', { onClick: this.switchStep.bind(this, 1) }, createElement('span', null, '\xA0>'))), this.renderWeekTitle()), this.renderBody());
			}
		});
